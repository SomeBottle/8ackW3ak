...
class RegNetY_3_2GF(RegNet):
    def __init__(self, num_classes=10):
        cfg = {
            "depths": [2, 5, 13, 1],
            "widths": [72, 216, 576, 1512],
            "strides": [1, 1, 2, 2],
            "group_width": 24,  # 组卷积每组通道数 g
            "bottleneck_ratio": 1,  # b = 1
            "se_ratio": 0.25,  # Y: 开启 SE, reduction≈1/4
        }
        super(RegNetY_3_2GF, self).__init__(cfg, num_classes=num_classes)


class RegNetY_1_6GF(RegNet):
    def __init__(self, num_classes=10):
        cfg = {
            "depths": [2, 6, 17, 2],
            ...
            "group_width": 24,
            "bottleneck_ratio": 1,
            "se_ratio": 0.25,  # Y: X + SE
        }
        super(RegNetY_1_6GF, self).__init__(cfg, num_classes=num_classes)
