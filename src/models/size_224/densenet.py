...
class DenseNet(ModelBase):
    ...
    def __init__(
        ...
        # Linear layer
        self._classifier = nn.Linear(num_features, num_classes)
...
class DenseNetBC121(DenseNet):
    def __init__(self, num_classes=10, efficient=True):
        """
        初始化 DenseNet-BC 121 模型

        :param num_classes: 分类类别数，默认值为 10
        :param efficient: 是否使用高效模式，默认值为 True
        """
...
class DenseNetBC169(DenseNet):
    def __init__(self, num_classes=10, efficient=False):
        """
        初始化 DenseNet-BC 169 模型

        :param num_classes: 分类类别数，默认值为 10
        :param efficient: 是否使用高效模式，默认值为 False
        """
